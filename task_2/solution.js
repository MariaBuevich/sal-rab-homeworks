...
function calcInvoice({sum, discountMinSum, discountPart, shippingFreeMinSum, shippingPrice}) {
    ...
    totalSum = totalSum - discountSum; // стоимость со скидкой
    ...
    let shippingSum = calcShipping(totalSum, shippingFreeMinSum, shippingPrice); // стоимость доставки при расчете суммы со скидкой
